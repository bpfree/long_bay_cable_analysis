##################################################################
### 0. Webscrape Data -- North Carolina DMF oyster sanctuaries ###
##################################################################
...
# Navigates to North Carolina oyster sanctuaries (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dmf-oyster-sanctuaries)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dmf-oyster-sanctuaries"
...
file.rename(from=file.path(download_dir, "DMF_ReefGuide_4581810839904183851.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "nc_oyster_sanctuaries.gpkg"))
