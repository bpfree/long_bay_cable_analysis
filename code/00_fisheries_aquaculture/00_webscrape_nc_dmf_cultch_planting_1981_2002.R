#############################################################################
### 0. Webscrape Data -- North Carolina DMF cultch planting (1981 - 2002) ###
#############################################################################
...
# Navigates to North Carolina DMF cultch planting (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::planting-sites-1981-2002)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::planting-sites-1981-2002"
...
file.rename(from=file.path(download_dir, "CultchApp2022.zip"),  # Make default download directory flexible
            ...
            to=file.path(data_dir, "nc_cultch_1981_2002.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "nc_cultch_1981_2002.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "nc_cultch_1981_2002.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "nc_cultch_1981_2002.zip"))
