################################################################
### 0. Webscrape Data -- North Carolina public fishing areas ###
################################################################
...
# Navigates to North Carolina public fishing areas (source: https://www.nconemap.gov/datasets/4f90f2e627f543fdb5bcea0ef6984d11_0)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://www.nconemap.gov/datasets/4f90f2e627f543fdb5bcea0ef6984d11_0"
...
file.rename(from=file.path(download_dir, "PFA.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "pfa.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "pfa.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "pfa.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "pfa.zip"))
