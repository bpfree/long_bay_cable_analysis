################################################################
### 0. Webscrape Data -- fish community assessment locations ###
################################################################
...
# Navigates to North Carolina DWR fish community assessment locations (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dwr-fish-community-assessment-locations/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dwr-fish-community-assessment-locations/about"
...
file.rename(from=file.path(download_dir, "DWR_Fish_Community_Assessment_Locations.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "DWR_Fish_Community_Assessment_Locations.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "DWR_Fish_Community_Assessment_Locations.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "DWR_Fish_Community_Assessment_Locations.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "DWR_Fish_Community_Assessment_Locations.zip"))
