###########################################################
### 0. Webscrape Data -- potentially underserved blocks ###
###########################################################
...
# Navigates to North Carolina DEQ's Potentially Underserved Block Groups 2019 (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::nc-deqs-potentially-underserved-block-groups-2019)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::nc-deqs-potentially-underserved-block-groups-2019"
