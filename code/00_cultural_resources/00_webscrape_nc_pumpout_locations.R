#############################################################
### 0. Webscrape Data -- North Carolina pumpout locations ###
#############################################################
...
# Navigates to North Carolina pumpout locations (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::pumpout-locations-north-carolina)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::pumpout-locations-north-carolina"
...
file.rename(from=file.path(download_dir, "Pumpouts_CleanMarinasNC_5166952413535609656.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "nc_pumpouts.gpkg"))
