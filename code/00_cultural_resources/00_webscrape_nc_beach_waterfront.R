###################################################################
### 0. Webscrape Data -- North Carolina beach waterfront access ###
###################################################################
...
# Navigates to North Carolina beach and waterfront access (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dcm-beach-and-waterfront-access)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::dcm-beach-and-waterfront-access/about"
...
file.rename(from=file.path(download_dir, "DCM_Beach_and_Waterfront_Access_-93139928382404078.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "nc_beach_waterfront.gpkg"))
