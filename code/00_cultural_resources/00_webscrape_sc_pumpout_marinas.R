###########################################################
### 0. Webscrape Data -- South Carolina marina pumpouts ###
###########################################################
...
# Navigates to South Carolina marina pumpouts (source: https://data-scdnr.opendata.arcgis.com/datasets/302c6991986c48a28f0ded8fd5a7bea8_0)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-scdnr.opendata.arcgis.com/datasets/302c6991986c48a28f0ded8fd5a7bea8_0"
...
file.rename(from=file.path(download_dir, "Marinas_with_Pumpout_view_-2350189442222683618.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "sc_pumpouts.gpkg"))
