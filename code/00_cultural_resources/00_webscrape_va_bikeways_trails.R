################################################
### 0. Webscrape Data -- bikeways and trails ###
################################################
...
# Navigates to Virginia Beach bikeways and trails (source: https://data.virginiabeach.gov/datasets/d347c7b7f8cc45ef86ce180ddcbd1e97_0)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data.virginiabeach.gov/datasets/d347c7b7f8cc45ef86ce180ddcbd1e97_0"
...
file.rename(from=file.path(download_dir, "Bikeways_and_Trails_2799736827134959461.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "va_beach_bikeways_trails.gpkg"))
