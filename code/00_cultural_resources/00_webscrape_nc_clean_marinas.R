#########################################################
### 0. Webscrape Data -- North Carolina clean marinas ###
#########################################################
...
# Navigates to North Carolina clean marinas (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::nc-clean-marinas/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::nc-clean-marinas/about"
...
file.rename(from=file.path(download_dir, "NC_Clean_Marinas_4238381206368691170.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "nc_clean_marinas.gpkg"))
