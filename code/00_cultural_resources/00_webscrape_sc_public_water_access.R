###############################################################
### 0. Webscrape Data -- South Carolina public water access ###
###############################################################
...
# Navigates to South Carolina public water access (source: https://data-scdnr.opendata.arcgis.com/datasets/scdnr::south-carolina-public-water-access)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-scdnr.opendata.arcgis.com/datasets/scdnr::south-carolina-public-water-access"
...
file.rename(from=file.path(download_dir, "South_Carolina_Public_Water_Access_1014862205874370304.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "sc_water_access.gpkg"))
