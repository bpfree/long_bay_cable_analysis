###################################################################
### 0. Webscrape Data -- U.S. electric power transmission lines ###
###################################################################
...
# Navigates to US electric power lines transmission (source: https://hub.arcgis.com/datasets/fedmaps::u-s-electric-power-transmission-lines/explore)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://hub.arcgis.com/datasets/fedmaps::u-s-electric-power-transmission-lines/explore"
...
### geopackage are the seventh dataset (after CSV, shapefile, geojson, geodatabase, feature collection, Excel -- and before SQLite geodatabase, GIS GeoService)
...
file.rename(from=file.path(download_dir, "US_Electric_Power_Transmission_Lines_-5453336193196279208.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "US_Electric_Power_Transmission_Lines.gpkg"))
