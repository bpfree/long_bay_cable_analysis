#################################################################
### 0. Webscrape Data -- underground storage tank facilities ###
#################################################################
...
# Navigates to underground storage tank facilities (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::ust-active-facilities/explore)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::ust-active-facilities/explore"
...
file.rename(from=file.path(download_dir, "UST_Active_Facilities_Public_5907272065002022061.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ust_active_facilities.gpkg"))
