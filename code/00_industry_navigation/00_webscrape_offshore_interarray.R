##############################################################
### 0. Webscrape Data -- offshore wind project inter-array ###
##############################################################
...
# Navigates to offshore wind - project inter-array cables (proposed or installed) (source: https://marinecadastre-noaa.hub.arcgis.com/datasets/BOEM::offshore-wind-project-inter-array-cables-proposed-or-installed/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://marinecadastre-noaa.hub.arcgis.com/datasets/BOEM::offshore-wind-project-inter-array-cables-proposed-or-installed/about"
...
file.rename(from=file.path(download_dir, "Offshore_Wind_-_Proposed_or_Installed_Project_Inter-array_Cables_2033369844090797673.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "offshore_wind_interarray_cables.gpkg"))
