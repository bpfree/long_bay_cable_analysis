######################################################
### 0. Webscrape Data -- petroleum tank facilities ###
######################################################
...
# Navigates to registered petroleum tank facilities (source: https://geohub-vadeq.hub.arcgis.com/datasets/137437097e1444a6aed31081b9812330_102)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://geohub-vadeq.hub.arcgis.com/datasets/137437097e1444a6aed31081b9812330_102"
...
file.rename(from=file.path(download_dir, "Registered_Petroleum_Tank_Facilities.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "Registered_Petroleum_Tank_Facilities.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "Registered_Petroleum_Tank_Facilities.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "Registered_Petroleum_Tank_Facilities.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "Registered_Petroleum_Tank_Facilities.zip"))
