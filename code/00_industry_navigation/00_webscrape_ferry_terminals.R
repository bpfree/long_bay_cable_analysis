############################################
### 0. Webscrape Data -- ferry terminals ###
############################################
...
# Navigates to ferry terminals (source: https://data-usdot.opendata.arcgis.com/datasets/usdot::ferry-terminals/about)
# and scrapes the site data for the states and regions of interest
  
# Base URL
base_url <- "https://data-usdot.opendata.arcgis.com/datasets/usdot::ferry-terminals/about"
...
file.rename(from=file.path(download_dir, "Ferry_Terminals.gdb.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ferry_terminals.gdb.zip"))

#####################################

## WARNING: Will have to manual unzip the file as the new names are very strange

file.rename(from=file.path(data_dir, "_ags_data445E2BC88CFB4104909CA5192C88D5F3.gdb"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ferry_terminals.gdb"))

## remove original zipped file
file.remove(file.path(data_dir, "ferry_terminals.gdb.zip"))
