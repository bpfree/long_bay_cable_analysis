################################################################
### 0. Webscrape Data -- channel markers and navigation aids ###
################################################################
...
# Navigates to channel markers and navigation aids (source: https://data.virginiabeach.gov/datasets/d4baaaa95a2c4002b0b30c25a924b761_31/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data.virginiabeach.gov/datasets/d4baaaa95a2c4002b0b30c25a924b761_31/about"
...
file.rename(from=file.path(download_dir, "Channel_Markers_and_Navigation_Aids.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "Channel_Markers_and_Navigation_Aids.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "Channel_Markers_and_Navigation_Aids.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "Channel_Markers_and_Navigation_Aids.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "Channel_Markers_and_Navigation_Aids.zip"))
