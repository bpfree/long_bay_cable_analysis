############################################
### 0. Webscrape Data -- marine highways ###
############################################
...
# Navigates to marine highways (source: https://data-usdot.opendata.arcgis.com/datasets/usdot::marine-highways/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-usdot.opendata.arcgis.com/datasets/usdot::marine-highways/about"
...
file.rename(from=file.path(download_dir, "Marine_Highways.gdb.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "Marine_Highways.gdb.zip"))

#####################################

## WARNING: Will have to manual unzip the file as the new names are very strange

file.rename(from=file.path(data_dir, "_ags_data7BA110E263764B1DB1D73F972FD24E8A.gdb"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "marine_highways.gdb"))

## remove original zipped file
file.remove(file.path(data_dir, "Marine_Highways.gdb.zip"))
