...
# Navigates to ferry routes (source: https://data-usdot.opendata.arcgis.com/datasets/usdot::ferry-routes/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-usdot.opendata.arcgis.com/datasets/usdot::ferry-routes/about"
...
file.rename(from=file.path(download_dir, "Ferry_Routes.gdb.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ferry_routes.gdb.zip"))

#####################################

## WARNING: Will have to manual unzip the file as the new names are very strange

file.rename(from=file.path(data_dir, "_ags_data16440BED27FF40FCA13B58B77270710B.gdb"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ferry_routes.gdb"))

## remove original zipped file
file.remove(file.path(data_dir, "ferry_routes.gdb.zip"))
