####################################################
### 0. Webscrape Data -- petroleum release sites ###
####################################################
...
# Navigates to petroleum release sites (source: https://geohub-vadeq.hub.arcgis.com/datasets/57759688e4944bb987add68c4f0c5ada_104/explore)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://geohub-vadeq.hub.arcgis.com/datasets/57759688e4944bb987add68c4f0c5ada_104/explore"
...
file.rename(from=file.path(download_dir, "Petroleum_Release_Sites.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "Petroleum_Release_Sites.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "Petroleum_Release_Sites.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "Petroleum_Release_Sites.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "Petroleum_Release_Sites.zip"))
