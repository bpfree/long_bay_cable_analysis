#################################################################
### 0. Webscrape Data -- offshore wind export cable locations ###
#################################################################
...
# Navigates to offshore wind - export cable locations (proposed or installed) (source: https://marinecadastre-noaa.hub.arcgis.com/datasets/BOEM::offshore-wind-export-cable-locations-proposed-or-installed/about)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://marinecadastre-noaa.hub.arcgis.com/datasets/BOEM::offshore-wind-export-cable-locations-proposed-or-installed/about"
...
file.rename(from=file.path(download_dir, "Offshore_Wind_-_Export_Cables_Proposed_Locations_-4600704880811109104.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "offshore_wind_export_cable.gpkg"))
