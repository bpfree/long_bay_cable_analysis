#################################################################
### 0. Webscrape Data -- North Carolina oceanfront shorelines ###
#################################################################
...
# Navigates to North Carolina oceanfront shorelines (source: https://ncdenr.maps.arcgis.com/home/item.html?id=61d1ae00e8b049e9a43620bdb24f302f)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://ncdenr.maps.arcgis.com/home/item.html?id=61d1ae00e8b049e9a43620bdb24f302f"
...
file.rename(from=file.path(download_dir, "dcm_oceanfront_shorelines.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "dcm_oceanfront_shorelines.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "dcm_oceanfront_shorelines.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "dcm_oceanfront_shorelines.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "dcm_oceanfront_shorelines.zip"))
