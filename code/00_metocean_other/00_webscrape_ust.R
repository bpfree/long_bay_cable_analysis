##########################################
### 0. Webscrape Data -- UST incidents ###
##########################################
...
# Navigates to UST incidents (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::ust-incidents)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::ust-incidents"
...
file.rename(from=file.path(download_dir, "Underground_Storage_Tank_Incidents_6760781595844812210.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "ust.gpkg"))
