###################################################
### 0. Webscrape Data -- hazaradous waste sites ###
###################################################
...
# Navigates to hazardous waste sites (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::hazardous-waste-sites)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::hazardous-waste-sites"
...
file.rename(from=file.path(download_dir, "HW_Sites_-2246201149909744236.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "hazardous_waste_sites.gpkg"))
