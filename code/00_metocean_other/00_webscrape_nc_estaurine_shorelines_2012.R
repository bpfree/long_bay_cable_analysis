#######################################################################
### 0. Webscrape Data -- North Carolina estuarine shorelines (2012) ###
#######################################################################
...
# Navigates to North Carolina estuarine shorelines (2012) (source: https://ncdenr.maps.arcgis.com/home/item.html?id=24daa404e32342758d1c84947c1e3953)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://ncdenr.maps.arcgis.com/home/item.html?id=24daa404e32342758d1c84947c1e3953"
...
file.rename(from=file.path(download_dir, "shoreline_estuarine_2012.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "shoreline_estuarine_2012.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "shoreline_estuarine_2012.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "shoreline_estuarine_2012.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "shoreline_estuarine_2012.zip"))
