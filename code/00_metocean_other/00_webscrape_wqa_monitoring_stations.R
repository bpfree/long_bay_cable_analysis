####################################################
### 0. Webscrape Data -- WQA monitoring stations ###
####################################################
...
# Navigates to WQA monitoring stations (source: https://geohub-vadeq.hub.arcgis.com/datasets/b2efe7c500254e5587f959c6f4c5feaf_143)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://geohub-vadeq.hub.arcgis.com/datasets/b2efe7c500254e5587f959c6f4c5feaf_143"
...
file.rename(from=file.path(download_dir, "2018_Final_WQA_Monitoring_Stations.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "wqa_stations.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "wqa_stations.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "wqa_stations.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "wqa_stations.zip"))
