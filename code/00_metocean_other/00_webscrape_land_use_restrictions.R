#########################################################
### 0. Webscrape Data -- notice land use restrictions ###
#########################################################
...
# Navigates to notice land use restrictions (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::notice-land-use-restrictions-view)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::notice-land-use-restrictions-view"
...
file.rename(from=file.path(download_dir, "NoticeLUR_View_-3018248965081534515.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "notice_land_use.gpkg"))
