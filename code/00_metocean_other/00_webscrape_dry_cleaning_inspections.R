#######################################################################
### 0. Webscrape Data -- dry cleaning historical boiler inspections ###
#######################################################################
...
# Navigates to dry cleaning historical boiler inspections (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::drycleaning-historical-boiler-inspections/)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::drycleaning-historical-boiler-inspections/"
...
file.rename(from=file.path(download_dir, "DryCleaning_Historical_Boiler_Inspections_2084057501518719856.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "dry_cleaning.gpkg"))
