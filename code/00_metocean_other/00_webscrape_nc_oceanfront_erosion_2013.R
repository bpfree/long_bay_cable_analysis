###########################################################################
### 0. Webscrape Data -- North Carolina oceanfront erosion sites (2013) ###
###########################################################################
...
# Navigates to North Carolina oceanfront erosion sites (2013) (source: https://ncdenr.maps.arcgis.com/home/item.html?id=2e7cf7cf5aab4d1c92e92c4ac397c1ca)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://ncdenr.maps.arcgis.com/home/item.html?id=2e7cf7cf5aab4d1c92e92c4ac397c1ca"
...
file.rename(from=file.path(download_dir, "er_2013.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "er_2013.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "er_2013.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "er_2013.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "er_2013.zip"))
