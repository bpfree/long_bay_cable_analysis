##########################################################
### 0. Webscrape Data -- pre-regulatory landfill sites ###
##########################################################
...
# Navigates to pre-regulatory landfill sites (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::pre-regulatory-landfill-sites-1)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::pre-regulatory-landfill-sites-1"
...
file.rename(from=file.path(download_dir, "Pre_Regulatory_Landfill_Sites_-1890000617135600158.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "prereg_landfill_sites.gpkg"))
