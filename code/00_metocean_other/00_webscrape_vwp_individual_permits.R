###################################################
### 0. Webscrape Data -- VWP individual permits ###
###################################################
...
# Navigates to VWP individual permits (source: https://geohub-vadeq.hub.arcgis.com/datasets/68834b17056f4d789b49e2e6f6cc6168_192)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://geohub-vadeq.hub.arcgis.com/datasets/68834b17056f4d789b49e2e6f6cc6168_192"
...
file.rename(from=file.path(download_dir, "VWP_Individual_Permits_(IP).zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "vwp_individual_permits.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "vwp_individual_permits.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "vwp_individual_permits.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "vwp_individual_permits.zip"))
