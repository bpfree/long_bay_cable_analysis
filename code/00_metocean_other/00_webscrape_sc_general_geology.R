###########################################################
### 0. Webscrape Data -- general geology South Carolina ###
###########################################################
...
# Navigates to general geology South Carolina (source: https://data-scdnr.opendata.arcgis.com/datasets/scdnr::general-geology-sc/)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-scdnr.opendata.arcgis.com/datasets/scdnr::general-geology-sc/"
...
file.rename(from=file.path(download_dir, "GeologicRegionsAGOL_2653602274957149075.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "sc_geology.gpkg"))
