#########################################################
### 0. Webscrape Data -- wastewater discharge permits ###
#########################################################
...
# Navigates to North Carolina NPDES wastewater discharge permits (source: https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::npdes-wastewater-discharge-permits)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://data-ncdenr.opendata.arcgis.com/datasets/ncdenr::npdes-wastewater-discharge-permits"
...
file.rename(from=file.path(download_dir, "NPDES_Wastewater_Discharge_Permits_-4149073193418289959.gpkg"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "nc_wastewater_permits.gpkg"))
