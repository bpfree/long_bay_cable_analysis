##################################################
### 0. Webscrape Data -- VPDES permit outfalls ###
##################################################
...
# Navigates to VPDES outfalls permits (source: https://geohub-vadeq.hub.arcgis.com/datasets/e27149e12fc744bd989ee304f27bd3e8_119)
# and scrapes the site data for the states and regions of interest

# Base URL
base_url <- "https://geohub-vadeq.hub.arcgis.com/datasets/e27149e12fc744bd989ee304f27bd3e8_119"
...
file.rename(from=file.path(download_dir, "VPDES_Permit_Outfalls.zip"),  # Make default download directory flexible
            # send to the raw data directory
            to=file.path(data_dir, "vpdes_permit_outfalls.zip"))

#####################################

# Unzip the data
## grab text before ".zip" and keep only text before that
new_dir_name <- sub(".zip", "", "vpdes_permit_outfalls.zip")

## create new directory for data
new_dir <- file.path(data_dir, new_dir_name)

## unzip the file
unzip(zipfile = file.path(data_dir, "vpdes_permit_outfalls.zip"),
      # export file to the new data directory
      exdir = new_dir)

## remove original zipped file
file.remove(file.path(data_dir, "vpdes_permit_outfalls.zip"))
